...
import (
	...
	"github.com/im-x/tusd/pkg/azurestore"
	"github.com/im-x/tusd/pkg/handler"
	"github.com/stretchr/testify/assert"
)

//go:generate mockgen -destination=./azurestore_mock_test.go -package=azurestore_test github.com/im-x/tusd/pkg/azurestore AzService,AzBlob
