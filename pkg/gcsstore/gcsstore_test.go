...
import (
	...
	"github.com/im-x/tusd/pkg/gcsstore"
	"github.com/im-x/tusd/pkg/handler"
)

// go:generate mockgen -destination=./gcsstore_mock_test.go -package=gcsstore_test github.com/im-x/tusd/pkg/gcsstore GCSReader,GCSAPI
